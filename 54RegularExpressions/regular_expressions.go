...
func main() {
	...
	// Create r, _ := regexp.Compile("p([a-z]+)ch")
	...
	// Print r.FindString("peach punch")
	...
	// Print r.FindStringIndex("peach punch")
	...
	// Print r.FindStringSubmatch("peach punch")
	...
	// Print r.FindAllString("peach punch pinch", 2)
	...
	// Create r = regexp.MustCompile("p([a-z]+)ch")
	...
	// Print r.ReplaceAllString("a peach", "<fruit>")
	fmt.Println("r.ReplaceAllString(\"a peach\", \"<fruit>\"):", r.ReplaceAllString("a peach", "<fruit>"))

	// The `Func` variant allows you to transform matched
	// text with a given function.

	// Create in := []byte("a peach")
	in := []byte("a peach")
	// Create out := r.ReplaceAllFunc(in, bytes.ToUpper)
