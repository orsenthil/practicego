...
func main() {
	...
	fmt.Println("then.Year():", then.Year())
	// TODO: Print then.Month()
	fmt.Println("then.Month():", then.Month())
	// TODO: Print then.Day()
	fmt.Println("then.Day():", then.Day())
	// TODO: Print then.Hour()
	fmt.Println("then.Hour():", then.Hour())
	// TODO: Print then.Minute()
	fmt.Println("then.Minute():", then.Minute())
	// TODO: Print then.Second()
	fmt.Println("then.Second():", then.Second())
	// TODO: Print then.Nanosecond()
	fmt.Println("then.Nanosecond():", then.Nanosecond())
	// TODO: Print then.Location()
	fmt.Println("then.Location():", then.Location())

	// The Monday-Sunday `Weekday` is also available.

	// TODO: Print then.Weekday()
	fmt.Println("then.Weekday():", then.Weekday())
