...
func main() {
	...
	fmt.Println(t1.Execute(os.Stdout, "some text"))
	// TODO: Execute t1 with 5
	fmt.Println(t1.Execute(os.Stdout, 5))
	// TODO: Execute t1 with []string{"Go", "Rust", "C++", "C#"}
	fmt.Println(t1.Execute(os.Stdout, []string{"Go", "Rust", "C++", "C#"}))
	...
	fmt.Println(t2.Execute(os.Stdout, struct {Name string}{"Jane Doe"}))
	...
	fmt.Println(t2.Execute(os.Stdout, map[string]string{"Name": "Mickey Mouse"}))
	...
	fmt.Println(t3.Execute(os.Stdout, "not empty"))
	// TODO: Execute t3 with ""
	fmt.Println(t3.Execute(os.Stdout, ""))
	...
	fmt.Println(t4.Execute(os.Stdout, []string{"Go", "Rust", "C++", "C#"}))
}